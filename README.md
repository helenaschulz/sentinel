...
**Kaggle competition**: [ESA-ADB Challenge](https://www.kaggle.com/competitions/esa-adb-challenge/leaderboard)
...
**Val F0.5 is the primary signal.** The 80/20 temporal split gives one held-out F0.5; Kaggle public confirms the threshold transfers to test. 5-fold temporal CV (NB 04 §6) confirms the 0.770 number is stable across training phases.
...
Download from the [Kaggle competition page](https://www.kaggle.com/competitions/esa-adb-challenge/data).
...
| File | Val F0.5 | Kaggle Public | Notes |
|---|---|---|---|
| `baseline_iforest.parquet` | 0.091 | ≈ 0.00 | IForest counter-example |
| `baseline_pca.parquet` | **0.770** | **0.522** | PCA reconstruction — best model |
